...
class DeconvolutionDialog(QDialog):
    ...
    def __init__(self, viewer, parent=None):
        ...
        # Populate combos now that both tabs exist -- _on_psf_selected()
        # touches sr_xy_spin/sr_z_spin (Solver tab), so this must run after
        # _build_solver_tab(), not from inside _build_source_psf_tab().
